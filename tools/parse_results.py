...
def parse_results(config_file, resultfile, dstpath, type):
    ...
    if 'obb_results_dict' in vars():
        ...
        for cls in obb_results_dict:
            with open(os.path.join(dstpath, 'Task1_results', 'Task1_' + cls + '.txt'), 'w') as obb_f_out:
    ...
    if 'hbb_results_dict' in vars():
        ...
        for cls in hbb_results_dict:
            with open(os.path.join(dstpath, 'Task2_results', 'Task2_' + cls + '.txt'), 'w') as f_out:
...
if __name__ == '__main__':
    ...
    # pkl_file = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_0.5test_ncms', 'results.pkl')
    # output_path = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_0.5test_ncms')
    # pkl_file = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_0.1mstest_cp5', 'results.pkl')
    # output_path = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_0.1mstest_cp5')
    pkl_file = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_fullcil1', 'results6.pkl')
    output_path = os.path.join('work_dirs', 'ReDet_re50_refpn_1x_dota1_fullcil1')
    type = args.type
