...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file=data_root +  'trainval1024/DOTA_trainval1024_fullchoose_0.05.json',
        ann_file=data_root +  'trainval1024/DOTA_trainval1024.json',
        img_prefix='datasets/DOTA_1024/' + 'trainval1024/images/',
        img_scale=(1024, 1024),
    ...
    test=dict(
        ...
        img_prefix='datasets/DOTA_1024/' + 'test1024/images',
        # ann_file=data_root + 'trainval1024/DOTA_trainval1024.json',
        # img_prefix='datasets/DOTA_1024/' + 'trainval1024/images/',
        # ann_file='demo/data/DOTA_test1024.json',
        # img_prefix='demo/data/images',
        img_scale=(1024, 1024),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
...
# load_from = 'work_dirs/ReDet_re50_refpn_1x_dota1_0.05co/epoch_3.pth' 
# load_from = 'work_dirs/ReDet_re50_refpn_1x_dota1_0.1mstest_cp4/epoch_12.pth'
# load_from ='work_dirs/ReDet_re50_refpn_1x_dota1_test1/epoch_12.pth'
load_from ='work_dirs/ReDet_re50_refpn_1x_dota1_fullcil/epoch_12.pth'
resume_from =None#  'work_dirs/ReDet_re50_refpn_1x_dota1_0.05rl1/epoch_9.pth'
workflow = [('train', 1)]
